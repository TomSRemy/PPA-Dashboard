...
[data-testid="stSlider"] div[data-baseweb="slider"] > div > div:first-child {{ background:{C3} !important; }}
[data-testid="stSlider"] div[role="slider"] {{ background:{C3} !important; border:1px solid {WHT} !important; box-shadow:none !important; }}
[data-testid="stSlider"] div[role="slider"]:hover {{ background:{C3} !important; }}
[data-testid="stSlider"] div[role="slider"]:focus {{ background:{C3} !important; box-shadow:none !important; }}
