...
[data-testid="stSlider"] > div > div > div {{ background: linear-gradient(90deg, {C3}, {C3}) !important; }}
[data-testid="stSlider"] > div > div > div > div {{ background-color: {C3} !important; border: 1px solid {WHT} !important; box-shadow: none !important; }}
