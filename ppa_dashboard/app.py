...
[data-testid="stSidebar"] {{ background: linear-gradient(180 deg, {C1}, #152A36) !important; }}
...
[data-testid="stSlider"] > div > div > div {{ background: linear-gradient(0deg, {C3}, {C3}) !important; }}
[data-testid="stSlider"] > div > div > div > div {{ background-color: {C4} !important; border: 2px solid {WHT} !important; }}
