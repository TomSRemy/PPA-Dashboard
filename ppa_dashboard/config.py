...
.ppa-card {{
    background: linear-gradient(0deg, {C2}, {C1}); color: {WHT};
...
.status-msg {{
    background: linear-gradient(0deg, {C2L}, {BG}); border: 1px solid {C2};
    border-radius: 8px; padding: 12px 18px; color: {C1} !important; font-weight: 500; margin: 10px 0;
}}
.wind-msg {{
    background: linear-gradient(0deg, {C_WIND_L}, {BG}); border: 1px solid {C_WIND};
    border-radius: 8px; padding: 12px 18px; color: {C1} !important; font-weight: 500; margin: 10px 0;
}}
...
.stButton > button {{
    background: linear-gradient(0deg, {C2}, {C1}) !important; color: {WHT} !important;
...
.stButton > button:hover {{ background: linear-gradient(0deg, {C1}, {C2}) !important; transform: translateY(-1px) !important; }}
.stDownloadButton > button {{ background: linear-gradient(0deg, {C3}, {C4}) !important; color: {C1} !important; border: none !important; font-weight: 700 !important; }}
...
[data-testid="stFileUploaderDropzone"] {{
    ...
    background: linear-gradient(0deg, {C2}, {C1}) !important;
